...
const chatHTML = `<main class="flex flex-column">
  <header class="title-bar flex flex-row flex-center">
    ...
    <div class="current-user flex"> </div>
  </header>
...
const showCurrentUser = async (email) => {
  document.querySelector('.current-user').innerHTML = email;
};
...
const login = async credentials => {
  try {
    if (!credentials) {
      ...
      console.log(payload);
      result = await client.authenticate(payload);
      console.log(result);
    }
    ...
    // Show current user
    showCurrentUser(credentials.email);
